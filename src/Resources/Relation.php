...
class Relation
{
    ...
    /**
     * Resource Query/Array component
     *
     * @var Flex
     */
    ...
    public function as(mixed $collection): self
    {
    ...
    // public function for(mixed $model): Flex
    // {
    //     return Flex::forDetail($model)->wrap($this->relationKey);
    // }
}
